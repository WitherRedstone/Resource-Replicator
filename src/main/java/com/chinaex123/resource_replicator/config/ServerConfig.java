...
public class ServerConfig {
    ...
    static {
        ...
        ITEM_TIER1_ENERGY_CONSUMPTION = BUILDER
                ...
                .defineInRange("energyConsumption", 100, 1, Integer.MAX_VALUE);
        BUILDER.pop();
        ...
        ITEM_TIER2_ENERGY_CONSUMPTION = BUILDER
                ...
                .defineInRange("energyConsumption", 200, 1, Integer.MAX_VALUE);
        BUILDER.pop();
        ...
        ITEM_TIER3_ENERGY_CONSUMPTION = BUILDER
                ...
                .defineInRange("energyConsumption", 300, 1, Integer.MAX_VALUE);
        BUILDER.pop();
        ...
        ITEM_TIER4_ENERGY_CONSUMPTION = BUILDER
                ...
                .defineInRange("energyConsumption", 400, 1, Integer.MAX_VALUE);
        BUILDER.pop();
        ...
        ITEM_TIER5_ENERGY_CONSUMPTION = BUILDER
                ...
                .defineInRange("energyConsumption", 500, 1, Integer.MAX_VALUE);
        BUILDER.pop();
